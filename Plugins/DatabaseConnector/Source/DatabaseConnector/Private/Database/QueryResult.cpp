...
FColumnMetadata::FColumnMetadata() {}

FColumnMetadata::FColumnMetadata(const FColumnMetadata& Other) 
...
FColumnMetadata::FColumnMetadata(FColumnMetadata&& Other)
	: DecimalDigits(Other.DecimalDigits)
	, DataTypeName(MoveTemp(Other.DataTypeName))
	, Size(Other.Size)
{
}
...
FColumnMetadata& FColumnMetadata::operator=(const FColumnMetadata& Other)
{
	DecimalDigits = Other.DecimalDigits;
	Size = Other.Size;
	DataTypeName = Other.DataTypeName;
...
FColumnMetadata& FColumnMetadata::operator=(FColumnMetadata&& Other)
{
	DecimalDigits = Other.DecimalDigits;
	Size = Other.Size;
	DataTypeName = MoveTemp(Other.DataTypeName);

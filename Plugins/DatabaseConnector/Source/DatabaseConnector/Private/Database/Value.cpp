...
FDatabaseValue::operator int32()	const
{
	...
	case EDatabaseValueType::Uint8:		return boost::get<uint8>(Internal->Get());
	case EDatabaseValueType::Boolean:	return boost::get<bool> (Internal->Get());
	case EDatabaseValueType::Int32:		return boost::get<int32>(Internal->Get());
	case EDatabaseValueType::Int64:
...
FDatabaseValue::operator int64()	const
{
	...
	case EDatabaseValueType::Boolean:	return boost::get<bool> (Internal->Get());
	case EDatabaseValueType::Int32:		return boost::get<int32>(Internal->Get());
	case EDatabaseValueType::Int64:		return boost::get<int64>(Internal->Get());
	case EDatabaseValueType::Double:
...
FDatabaseValue::operator double()	const
{
	...
	case EDatabaseValueType::Int32:		return boost::get<int32> (Internal->Get());
	case EDatabaseValueType::Int64:		return boost::get<int64> (Internal->Get());
	case EDatabaseValueType::Double:	return boost::get<double>(Internal->Get());
	}
...
FString FDatabaseValue::ToString(bool bWarn) const
{
	...
	case EDatabaseValueType::Uint8:		
		...
		return FString::Printf(TEXT("%f"), boost::get<uint8>(Internal->Get()));
	...
	case EDatabaseValueType::Timestamp:
	{
		...
		const FDatabaseTimestamp Timestamp = boost::get<FDatabaseTimestamp>(Internal->Get());
	...
	{
		if (bWarn) UE_LOG(LogDatabaseValue, Warning, TEXT("Converted a database value from double to FDatabaseTimestamp."));
		const FDatabaseDate Timestamp = boost::get<FDatabaseDate>(Internal->Get());
		return FString::Printf(TEXT("%04d-%02d-%02d"),
			Timestamp.Year, Timestamp.Month, Timestamp.Day);
	}
	case EDatabaseValueType::String:
		return boost::get<FString>(Internal->Get());
...
FDatabaseValue::operator FDatabaseTimestamp() const
{
	...
	{
		return boost::get<FDatabaseTimestamp>(Internal->Get());
	}
...
FDatabaseValue::operator FDatabaseDate()	const
{
	...
	{
		return boost::get<FDatabaseDate>(Internal->Get());
	}
...
#		undef MakeVisitorFunc
	...
	boost::apply_visitor(Visitor, Internal->Get());

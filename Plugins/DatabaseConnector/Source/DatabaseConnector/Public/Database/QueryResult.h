...
public:
	FColumnMetadata();
	FColumnMetadata(const FColumnMetadata& Other);
	FColumnMetadata(FColumnMetadata&& Other);

	FColumnMetadata& operator=(const FColumnMetadata& Other);
	FColumnMetadata& operator=(FColumnMetadata&& Other);
